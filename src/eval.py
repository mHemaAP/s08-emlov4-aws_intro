...
def test(
    ...
    if trainer.checkpoint_callback.best_model_path:
        ...
        test_metrics = trainer.test(model, datamodule=datamodule,verbose=False,ckpt_path=cfg.ckpt_path)
...
def main(cfg: DictConfig):
    ...
    plot_confusion_matrix(model=model,datamodule=datamodule,path=os.path.join(Path(cfg.paths.root_dir),'assets',''))
